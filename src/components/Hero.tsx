        ...
        <CarouselContent>
          <CarouselItem>
            ...
            <div className="absolute w-screen h-screen z-1 top-0 bg-linear-to-r from-black/40 to-transparent">
              <div
                ...
                ${current === 0 ? "animate-slide-up" : "opacity-0 translate-y-10"}
                `}
              >
                <p className="text-white bg-amber-600 w-fit px-5 mb-3 rounded-4xl">
                  Lançamento
                </p>
                ...
                <Link
                  to="/"
                  className="text-white bg-amber-600 px-7 py-3 rounded-2xl"
                >
                  Comprar
                </Link>
              </div>
          ...
          <CarouselItem>
            ...
            <div className="absolute w-screen h-screen z-1 top-0 bg-linear-to-r from-black/40 to-transparent">
              <div
                className={`
                absolute z-30 top-[30%] left-[5%]
                ${current === 1 ? "animate-slide-up" : "opacity-0 translate-y-10"}
                `}
              >
                <p className="text-white bg-amber-600 w-fit px-5 mb-3 rounded-4xl">
                  Lançamento
          ...
          <CarouselItem>
            ...
            <div className="absolute w-screen h-screen z-1 top-0 bg-linear-to-r from-black/40 to-transparent">
              <div className={`
                absolute z-30 top-[30%] left-[5%]
                ${current === 2 ? "animate-slide-up" : "opacity-0 translate-y-10"}
                `}>
                <p className="text-white bg-amber-600 w-fit px-5 mb-3 rounded-4xl">
                  Lançamento
                </p>
